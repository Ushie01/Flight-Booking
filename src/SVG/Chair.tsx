...
export const ChairSvg = ({ width, height, color }: Props) => {
	return (
		<svg
			...
			<path
				d='M13.1666 6V4.00001C13.1666 3.64638 13.0262 3.30724 12.7761 3.0572C12.5261 2.80715 12.1869 2.66667 11.8333 2.66667H5.16665C4.81302 2.66667 4.47389 2.80715 4.22384 3.0572C3.97379 3.30724 3.83331 3.64638 3.83331 4.00001V6'
				stroke='#555555'
				stroke-width='1.5'
