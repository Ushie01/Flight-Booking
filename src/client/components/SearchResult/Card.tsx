            ...
            <div className="p-4 mt-10">
                <div className="flex flex-row items-center justify-between font-bold">
                    <div className="flex flex-row items-center justify-start">
                        <div className="border font-bold p-1 rounded-md">
                            Logo
                        </div>
            ...
            <div className="p-4 mt-3">
                <div className="flex flex-row items-center justify-between text-gray-500">
                    <div className="flex flex-row items-center justify-start space-x-1">
                        <ChairSvg width="24" height="24" color="white" />
                ...
                <button className="font-bold text-xl text-white w-full pt-3 pb-3 bg-orange-50 shadow-lg rounded-lg mt-5">Check</button>
            </div>
        </div>
    )
}
