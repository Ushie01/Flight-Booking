  ...
  return (
    ...
    <div className='flex flex-col items-center justify-center'>
      ...
      <div className='p-4 bg-white rounded-lg mt-7 w-full shadow-lg'>
        ...
        <Button color='orange' className='w-full bg-orange-50 text-bold mt-6 text-white rounded-xl'>Search</Button>
      </div>
      </div>
        ...
        <div className='flex flex-row items-start justify-start rounded-lg mb-24 mt-5 bg-white'>
          <Image src={Frame} alt='Frame Image' width={120}  />
          <div className='flex flex-col items-start justify-start p-3 pt-2'>
            <p className='text-2xl font-extrabold'>15% Discount <br /> with mastercard</p>
            <p className='text-xl text-gray-500'>Lorem ipsum dolor <br /> sit am etet adip</p>
          </div>
        </div>
      <Navbar />
    </div>
